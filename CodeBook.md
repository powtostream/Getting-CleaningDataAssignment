...
Activity performed by the subject including:
...
For each measurement from the original data set were extracted only mean and standard deviation


## List of measured features
For each feature were selected only *mean* and *standard deviation* values. 
prefix 't' to denote time.
prefix 'f' to indicate frequency domain signals.
'MEAN' and 'STD' to indicate mean and standard deviation respectively.
